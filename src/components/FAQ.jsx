...
const FAQ = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Registration is simple. Click on the 'Get ID' button contact us on WhatsApp at +16402396837. Our support team will help you create your account instantly."
        },
        {
        ...
        },
        {
            ...
            answer: "Our customer support is available 24/7. You can contact us via WhatsApp at +16402396837 or use the Live Chat feature on our website."
        },
        {
        ...
        },
        {
            ...
            answer: "The official WhatsApp number for Reddyanna Book is +16402396837."
        }
    ];
