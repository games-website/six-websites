        ...
        <div className="md:col-span-8 space-y-12">
            ...
            <section className="bg-[#1a1a1a] p-6 rounded-xl border border-white/5">
                <h2 className="text-2xl font-bold text-yellow-500 mb-4 flex items-center gap-2">
                    <Globe className="text-white w-6 h-6" /> About Myleasers
                </h2>
                <p className="text-gray-400 leading-relaxed mb-4">
                    Myleasers is India's first legal and compliant gaming platform, revolutionizing the online betting industry. Established in 2016, we have grown to become the most trusted exchange for sports betting and live casino games.
                </p>
            ...
            <section className="bg-gradient-to-r from-yellow-900/20 to-transparent p-6 rounded-xl border-l-4 border-yellow-500">
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                    <ShieldCheck className="text-green-500 w-6 h-6" /> Why Myleasers is Trusted?
                </h2>
                ...
                <div className="bg-[#1a1a1a] p-6 rounded-xl border border-white/5 flex flex-col md:flex-row gap-6 items-center">
                    <div className="flex-1 space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-sm text-gray-300">Visit <strong>myleasers.in</strong> official site.</p>
                        </div>
                        <div className="flex items-center gap-3">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-[#1a1a1a] p-3 rounded-xl border border-white/5">
                        ...
                        <p className="text-xs text-gray-400">"Small or big amount, Myleasers always pays on time."</p>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="bg-[#1a1a1a] p-4 rounded border border-white/5 flex gap-4">
                    ...
                    <div>
                        <h4 className="font-bold text-sm">IPL 2026 Auctions Date Announced</h4>
