            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6 text-gray-900 leading-tight relative inline-block">
                        ...
                        <span className="block h-1 w-24 bg-yellow-600 mx-auto mt-4 rounded-full"></span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {stats.map((stat, index) => (
                        <div key={index} className="bg-white p-8 rounded-2xl border border-gray-200 hover:border-yellow-600/50 transition-all duration-300 group text-center h-full flex flex-col items-center shadow-sm hover:shadow-lg">
                            <div className="w-20 h-20 bg-yellow-500 rounded-full flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
                                {stat.icon}
                            </div>
