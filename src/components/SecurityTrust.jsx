...
const securityFeatures = [
    ...
    "Getting your verified Goldplay ID is the first step toward safe, long-term betting."
];
            ...
            <div className="container mx-auto max-w-7xl">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="lg:w-1/2">
                        <h2 className="text-3xl md:text-5xl font-bold mb-10 text-brand-gold leading-tight">
                        ...
                        <ul className="space-y-4">
                            {securityFeatures.map((feature, index) => (
                                <li key={index} className="flex items-start gap-3">
                                    <ArrowRight className="text-brand-gold flex-shrink-0 mt-1" size={20} />
                    ...
                    <div className="lg:w-1/2 flex justify-center">
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl hover:scale-[1.02] transition-transform duration-300">
                            <img
                                src={secureIcon}
                                alt="Security & Trust of Goldplay Platform"
