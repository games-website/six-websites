                ...
                <div className="container mx-auto flex overflow-x-auto no-scrollbar">
                    <div id="desktop-nav" className="flex">
                        {navItems.map((item) => {
                            ...
                            // Normalize simple path matching
                            const isActive = path === '/' 
                                ? location.pathname === '/' 
                            ...
                            return (
                                <Link
                                    key={item}
                                    to={path}
                                    className={`px-6 py-3 text-sm font-bold uppercase tracking-wider border-b-2 transition-all hover:bg-white/5 whitespace-nowrap block ${isActive
