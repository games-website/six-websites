    ...
    return (
        <header class="header">
            <div class="container header-container">
                ...
                <a href="https://wa.me/447735317489" target="_blank" rel="noopener noreferrer" className="mobile-header-btn btn-gold">GET ID</a>
                <button
                ...
                <a href="https://wa.me/447735317489" target="_blank" rel="noopener noreferrer" class="desktop-only-btn btn-gold">GET ID</a>
            </div>
        </header >
    );
};
