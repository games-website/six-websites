        ...
        <header>
            <div className="container header-content">
                ...
                <div className="header-actions">
                    <a id='get-id-nav-btn' href="https://wa.me/16402396837?text=Hello%20Lotus365%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="get-id-header-btn">
                        Get ID
                    </a>
