    ...
    return (
        <section className="py-20 bg-white text-gray-900 px-4 border-t border-gray-100">
            <div className="container mx-auto max-w-6xl">
                <h2 className="text-3xl md:text-4xl font-bold mb-16 text-center text-yellow-600 uppercase tracking-wide">
                    Legal Compliance & Responsible Gaming
                </h2>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">

                    {/* Left Column: Compliance Framework */}
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={index} className="flex items-start gap-3">
                                    <Check className="text-yellow-600 flex-shrink-0 mt-1" size={20} strokeWidth={3} />
