            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {courses.map((course, index) => (
                        <div key={index} className="bg-gray-50 p-6 rounded-xl border border-gray-200 hover:border-yellow-600 transition-colors cursor-pointer group shadow-sm hover:shadow-md">
                            <div className="mb-4 text-yellow-600 bg-yellow-600/10 w-fit p-3 rounded-lg group-hover:bg-yellow-600 group-hover:text-white transition-colors">
                                {course.icon}
                            </div>
