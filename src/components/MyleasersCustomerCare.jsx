...
const MyleasersCustomerCare = () => {
    return (
        <section class="section bg-subtle-mint">
            <div class="container">
                <h2 class="section-title">Customer Care Services at Myleasers</h2>
                ...
                <div class="customer-care-banner mb-40" style={{ display: 'flex', justifyContent: 'center' }}>
                    <img src="/images/myleasers_support_new.png" alt="MYLEASERS Customer Care"
...
export default MyleasersCustomerCare;
