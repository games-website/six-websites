...
const Login = () => {
    ...
    return (
        <section class="section login-section bg-light-alt" id="login">
            <div class="container">
                <h2 class="section-title">Myleasers Login Process</h2>
                <div class="split-content reverse-mobile">
                    <div class="image-content">
                        <img src="/images/myleasers_login_visual.png" alt="Login Welcome" />
                    </div>
                    <div class="text-content">
                        <p class="section-desc">Here’s how you can log in with ease:</p>
                        <ul class="custom-list">
                            <li><strong>Visit the Platform:</strong> To access the <strong>Myleasers Book</strong> website
