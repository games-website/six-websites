...
const faqs = [
    { q: "Is Myleasers Legal in India?", a: "Myleasers operates legally in countries where online betting is permitted. We are a licensed platform ensuring a safe environment for all users." },
