            ...
            <div class="container">
                ...
                <div class="split-content">
                    <div class="text-content">
                        ...
                        <a href="https://wa.me/16402396837?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" class="btn-black-gold">
                            <i class="fab fa-whatsapp"></i> SignUp Now
                        </a>
                    </div>
                    <div class="image-content">
                        <img src="/images/myleasers_registration_new.png" alt="Registration Process" />
                    </div>
                </div>
            </div>
        </section>
