            ...
            <div className="container footer-content">
                ...
                <div className="footer-column contact-column">
                    ...
                    <div className="contact-info">
                        <a href="https://wa.me/15208005239?text=Hello%20Lotus365%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                            <span className="phone-icon">💬</span> +15208005239
                        </a>
                    </div>
