            ...
            <div className="container footer-content">
                ...
                <div className="footer-column contact-column">
                    ...
                    <div className="contact-info">
                        <a href="https://wa.me/447735317489" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                            <span className="phone-icon">💬</span> +447735317489
                        </a>
                    </div>
