            ...
            <div className="container footer-content">
                ...
                <div className="footer-column contact-column">
                    ...
                    <div className="contact-info">
                        <a href="https://wa.me/16402396837?text=Hello%20Lotus365%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                            <span className="phone-icon">💬</span> +16402396837
                        </a>
                    </div>
