        ...
        <footer className="bg-gray-100 text-gray-900 pt-16 pb-8 border-t border-gray-200 relative">
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 mb-16">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="bg-white p-1 rounded-sm w-16 h-16 flex items-center justify-center shadow-md">
                                <img src={logo} alt="Mahadev Book Logo" className="w-full h-full object-contain" />
                            </div>
                            <h3 className="text-2xl font-bold text-yellow-600 tracking-wide">Mahadev Book</h3>
                        </div>
                        ...
                        <div className="flex gap-3">
                            {[
                                ...
                                <a
                                    key={index}
                                    href="#"
                                    className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-gray-500 hover:bg-yellow-500 hover:text-white shadow-sm transition-all duration-300"
                                    aria-label={label}
                                >
                                    <Icon size={18} />
                                </a>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-600 text-sm">
                            ...
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">Mahadev Betting App</a></li>
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">Mahadev Book ID</a></li>
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">FAQ</a></li>
                        </ul>
                    </div>

                    {/* Betting Platforms Column */}
                    <div>
                        <h4 className="text-lg font-bold text-gray-900 mb-6 relative inline-block">
                            Betting Platforms
                            <span className="absolute -bottom-2 left-0 w-12 h-1 bg-yellow-500 rounded-full"></span>
                        ...
                        <ul className="space-y-3 text-gray-600 text-sm">
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">Gold365</a></li>
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">Laser247</a></li>
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">IPL Betting ID</a></li>
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">Online Betting ID</a></li>
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">Mahadev Online Book</a></li>
                            <li><a href="#" className="hover:text-yellow-600 transition-colors">MahadevBook</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-200 pt-8 text-center">
                    ...
                    <p className="text-gray-500 text-xs mb-4 max-w-3xl mx-auto">
                    ...
                    <div className="text-gray-500 text-sm">
                        <a href="#" className="hover:text-yellow-600 transition-colors">Terms & Conditions</a>
