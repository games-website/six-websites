                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 border-b border-white/5 pb-8">
                    <div className="md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            <a href="https://wa.me/16402396837?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." className="bg-green-600 hover:bg-green-700 text-white text-xs font-bold px-4 py-2 rounded-full flex items-center gap-2 transition-all">
