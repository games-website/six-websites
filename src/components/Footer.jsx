            ...
            <div className="container footer-content">
                ...
                <div className="footer-column contact-column">
                    ...
                    <div className="contact-info">
                        <a href="https://wa.me/15208005239" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                            <span className="phone-icon">💬</span> +1(520)800-5239
                        </a>
                    </div>
