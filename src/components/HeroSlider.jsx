...
const HeroSlider = () => {
    ...
    return (
        <div className="relative h-48 md:h-80 rounded-xl overflow-hidden mb-6 mx-4 md:mx-0 shadow-2xl shadow-black/50 group">
            <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." className={`absolute inset-0 bg-gradient-to-r ${b.color} transition-all duration-700 ease-in-out flex flex-col justify-center items-center text-center p-6 banner-transition`}>
