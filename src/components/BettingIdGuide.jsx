        ...
        <section className="py-20 bg-white text-gray-900 px-4 border-t border-gray-100">
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="text-center mb-16">
                    ...
                    <div className="h-1 w-16 bg-brand-gold mx-auto mb-6"></div>
                    <p className="text-gray-600 text-lg">
                        Your essential guide to unlocking safe and strategic betting with Goldplay
                    </p>
                </div>

                
                <div className="mb-12">
                    <h3 className="text-2xl font-bold text-brand-gold mb-4">What is a Goldplay ID?</h3>
                    <p className="text-gray-700 leading-relaxed mb-4">
                        Your <strong className="text-brand-gold">Goldplay ID</strong> is a personal access key to India’s trusted online betting ecosystem. With it, you can securely place bets on sports, casino games, and virtual matches within a single platform.
                    </p>
                ...
                <div className="mb-12">
                    <h3 className="text-2xl font-bold text-brand-gold mb-8">How to Use It Smartly</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">

                        
                        <div className="bg-gray-50 p-8 rounded-xl border border-gray-200">
                            <h4 className="text-xl font-bold text-blue-600 mb-3">Secure Account Access</h4>
                        ...
                        <div className="bg-gray-50 p-8 rounded-xl border border-gray-200">
                            <h4 className="text-xl font-bold text-blue-600 mb-3">Explore Betting Markets</h4>
                            <p className="text-gray-600 text-sm leading-relaxed">
                        ...
                        <div className="bg-gray-50 p-8 rounded-xl border border-gray-200">
                            <h4 className="text-xl font-bold text-blue-600 mb-3">Track and Manage Bets</h4>
                            <p className="text-gray-600 text-sm leading-relaxed">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-t border-gray-200 pt-8">
                    <div>
                        <h3 className="text-2xl font-bold text-brand-gold mb-2">Responsible Betting</h3>
                        <p className="text-gray-600">
                            Your Goldplay ID unlocks exciting opportunities — but it’s equally important to bet responsibly:
                        </p>
                    </div>
