    ...
    return (
        <div className="bg-gradient-to-r from-green-900/40 to-green-800/20 p-4 rounded-xl border border-green-500/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:bg-green-500/10 p-2 rounded-lg transition-colors">
                    <div className="w-10 h-10 bg-green-500/20 rounded-full flex items-center justify-center text-green-400">
                        <Phone className="w-5 h-5" />
                    </div>
                    <div>
                        <div className="font-bold text-sm">WhatsApp Support</div>
                        <div className="text-xs text-gray-400">+1 520 800 5239</div>
                    </div>
                </a>
            </div>
        </div>
