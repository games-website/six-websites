        ...
        <section class="section bg-subtle-grey">
            <div class="container">
                ...
                <div class="center-btn mt-40">
                    <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" class="btn-black-gold"><i class="fab fa-whatsapp"></i> Deposit Now and Start Playing!</a>
                </div>
            </div>
        </section>
    );
