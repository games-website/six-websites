...
const Deposit = () => {
    return (
        <section class="section bg-subtle-grey">
            <div class="container">
                <h2 class="section-title">How to Deposit Money into Your Myleasers Account</h2>
                <p class="text-center mb-40">You can add money to your balance easily using our reliable deposit system as
                    follows:</p>
                <div class="deposit-grid">
                    <div class="deposit-card">
                        <h3>Login</h3>
                        <p>Get into your Myleasers book account.</p>
                    </div>
                    <div class="deposit-card">
                ...
                <div class="center-btn mt-40">
                    <a href="https://wa.me/12397991318?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" class="btn-black-gold"><i class="fab fa-whatsapp"></i> Deposit Now and Start Playing!</a>
                </div>
            </div>
        </section>
    );
