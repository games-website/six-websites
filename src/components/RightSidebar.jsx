        ...
        <div className="md:col-span-4 space-y-6">
            ...
            <div className="bg-gradient-to-b from-yellow-600 to-yellow-800 p-6 rounded-xl text-center shadow-xl">
                ...
                <div className="space-y-3">
                    <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="w-full bg-black text-white font-bold py-3 rounded flex items-center justify-center gap-2 border border-black hover:bg-gray-900 transition-colors">
                        <span className="text-xl">🤖</span> Android APK
                    </a>
                    <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="w-full bg-white text-black font-bold py-3 rounded flex items-center justify-center gap-2 border border-white hover:bg-gray-100 transition-colors">
