...
const BettingSteps = () => {
    return (
        <section class="section betting-steps-section" id="rules">
            <div class="container">
                <h2 class="section-title">How to Place a Bet at Myleasers Book</h2>
                <p class="text-center mb-40">At <strong>Myleasers Book</strong> placing a bet is a simple and convenient
                ...
                <div class="center-btn mt-40">
                    <a href="https://wa.me/16402396837?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" class="btn-black-gold"><i class="fab fa-whatsapp"></i> Ready to Bet? Start
                        Here!</a>
                </div>
            </div>
        </section>
