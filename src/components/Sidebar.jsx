    ...
    return (
        <div className="hidden lg:block space-y-4">
            ...
            <div className="bg-gradient-to-br from-yellow-600 to-yellow-800 rounded-lg p-4 text-center">
                ...
                <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="w-full bg-black text-yellow-500 font-bold py-2 rounded flex items-center justify-center gap-2 hover:bg-gray-900 transition-colors">
