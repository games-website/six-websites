        ...
        <section className="py-20 bg-white text-gray-900">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6 text-brand-gold leading-tight">
                        Our Users Speak for Us – Goldplay Always Delivers <br className="hidden md:block" />
                        100% Guaranteed Withdrawals.
                    </h2>
                    <div className="w-24 h-1 bg-brand-gold mx-auto mb-8"></div>
                    <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                        Real WhatsApp feedback from verified Goldplay users who enjoy our trusted and fast betting services.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="relative group">
                        <img
                            ...
                            className="w-full h-auto rounded-3xl border-4 border-gray-100 shadow-xl transition-transform transform group-hover:scale-105"
                        />
                    </div>
                    <div className="relative group">
                        <img
