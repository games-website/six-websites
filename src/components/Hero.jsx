        ...
        <section class="hero-section" id="home">
            <div class="container hero-container">
                <div class="hero-content">
                    ...
                    <a href="https://wa.me/16402396837?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" class="btn-hero-glow"><i class="fab fa-whatsapp"></i> Get Your Online ID Now</a>
                </div>
                <div className="hero-image reveal">
                    <img src="/images/myleasers_hero.png" alt="Myleasers Hero" />
                </div>
            </div>
        </section>
    );
