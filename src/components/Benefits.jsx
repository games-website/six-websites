...
const benefitsList = [
    ...
    },
    {
        ...
        desc: "From IPL to roulette, your Goldplay ID gives access to the best betting markets in India. The interface is responsive, user-friendly, and always aligned with the latest events. Whether you're a beginner or a pro, this is the betting space you deserve.",
        align: "right"
    }
];
    ...
    return (
        <section className="py-20 bg-gray-50 text-gray-900 border-t border-gray-200">
            <div className="container mx-auto px-4 max-w-5xl">
                <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center text-brand-gold">
                    Top Benefits of Your Goldplay Online Betting ID
                </h2>
                    ...
                    {benefitsList.map((benefit, index) => (
                        <div key={index} className={`flex flex-col md:flex-row items-center gap-6 md:gap-12 ${benefit.align === 'left' ? 'md:flex-row-reverse' : ''}`}>
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <h3 className="text-2xl font-bold text-brand-gold mb-3">{benefit.title}</h3>
                            ...
                            <div className="flex-shrink-0">
                                <Check size={48} strokeWidth={4} className="text-brand-gold" />
                            </div>
                ...
                <div className="mt-16 text-right border-t border-gray-200 pt-8">
                    <a
