    ...
    return (
        <section className="py-20 bg-gray-50 text-gray-900 border-t border-gray-200">
            <div className="container mx-auto px-4 max-w-5xl">
                <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center text-yellow-600">
                    ...
                    {benefitsList.map((benefit, index) => (
                        <div key={index} className={`flex flex-col md:flex-row items-center gap-6 md:gap-12 ${benefit.align === 'left' ? 'md:flex-row-reverse' : ''}`}>
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <h3 className="text-2xl font-bold text-yellow-600 mb-3">{benefit.title}</h3>
                            ...
                            <div className="flex-shrink-0">
                                <Check size={48} strokeWidth={4} className="text-yellow-600" />
                            </div>
