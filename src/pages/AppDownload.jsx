    ...
    return (
        <div className="app-download-page" style={{ backgroundColor: '#0d1425', color: '#fff', minHeight: '100vh', paddingTop: '100px' }}>
            ...
            <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', textAlign: 'center', marginBottom: '80px' }}>
                ...
                <a href="https://wa.me/16402396837?text=Hello%20Reddyanna%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={downloadButtonStyle}>
                ...
                <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px', marginTop: '40px' }}>
                        ...
                        <div style={gameCardStyle}>
                            ...
                            <a href="https://wa.me/16402396837?text=Hello%20Reddyanna%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={{ ...downloadButtonStyle, background: '#00e5ff', color: '#000', width: '100%' }}>DOWNLOAD & PLAY</a>
                        </div>
                        {}
                        <div style={gameCardStyle}>
                            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
                            ...
                            <a href="https://wa.me/16402396837" target="_blank" rel="noopener noreferrer" style={{ ...downloadButtonStyle, background: '#00e5ff', color: '#000', width: '100%' }}>DOWNLOAD & PLAY</a>
                        </div>
                        {}
                        <div style={gameCardStyle}>
                            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
