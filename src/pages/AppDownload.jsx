    ...
    return (
        <div className="app-download-page" style={{ backgroundColor: '#111111', color: '#fff', minHeight: '100vh', paddingTop: '100px' }}>
            ...
            <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', textAlign: 'center', marginBottom: '80px' }}>
                ...
                <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={downloadButtonStyle}>
                    ...
                    <div style={{ flex: '1', minWidth: '300px', textAlign: 'center' }}>
                        <div style={{
                            ...
                            <h2 style={{ color: '#eab308', fontSize: '36px', marginBottom: '20px', textTransform: 'uppercase' }}>Myleasers App</h2>
                                ...
                                <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={{ ...downloadButtonStyle, background: '#00e5ff', color: '#000', padding: '15px 40px' }}>GET APP NOW</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px', marginTop: '40px' }}>
                        ...
                        <div style={gameCardStyle}>
                            ...
                            <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={{ ...downloadButtonStyle, background: '#00e5ff', color: '#000', width: '100%' }}>DOWNLOAD & PLAY</a>
                        </div>
                        {}
                        <div style={gameCardStyle}>
                            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
            ...
            <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 20px', display: 'flex', flexWrap: 'wrap', gap: '50px' }}>
                <div style={{ flex: '1', minWidth: '300px' }}>
                    ...
                    <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={downloadButtonStyle}>DOWNLOAD APP NOW</a>
                </div>
                <div style={{ flex: '1', minWidth: '300px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <div style={{
                        ...
                        <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={{ ...downloadButtonStyle, padding: '15px 40px' }}>GET Myleasers APP</a>
                    </div>
                </div>
            </div>
