                ...
                <section className="bg-gray-100 py-16 px-4 relative overflow-hidden">
                    ...
                    <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-12 relative z-10">
                        <div className="flex-1 min-w-[300px] text-center md:text-left">
                            <div className="border border-purple-200 bg-purple-100 rounded-full py-2 px-6 mb-6 inline-block text-purple-600 text-lg font-bold tracking-wide animate-pulse">
                                🎮 Goldplay Fantasy Sports
                            </div>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight uppercase bg-gradient-to-r from-purple-600 via-pink-600 to-brand-gold bg-clip-text text-transparent">
                                Play, Compete & Win
                            </h1>
                ...
                <section className="bg-white py-20 px-4">
                    <div className="container mx-auto max-w-6xl">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Play Fantasy Sports?</h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {[
                                ...
                                <div key={idx} className="bg-gray-50 border border-gray-100 p-8 rounded-2xl hover:border-brand-gold/50 transition-all duration-300 flex items-start gap-5 shadow-sm">
                                    <div className="text-4xl bg-white w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0 shadow-inner">{item.icon}</div>
                                    <div>
                ...
                <section className="bg-gray-100 py-20 px-4">
                    <div className="container mx-auto max-w-5xl">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h3 className="text-3xl font-bold text-gray-900 mb-6">How to Win?</h3>
                                <p className="text-gray-600 mb-8 text-lg font-medium">
                                    Winning on Goldplay Fantasy is about skill and strategy.
                                </p>
                                <ul className="space-y-4">
                                    {[
                                        ...
                                        <li key={i} className="flex items-center gap-4 bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                                            <div className="w-8 h-8 rounded-full bg-gold-gradient text-white font-bold flex items-center justify-center">{i + 1}</div>
                                            <span className="text-gray-800 font-semibold">{step}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                            <div className="bg-white p-8 rounded-2xl border border-brand-gold/20 text-center shadow-lg">
                                <h3 className="text-2xl font-bold text-gray-900 mb-6">Grand Leagues</h3>
