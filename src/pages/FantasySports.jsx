            ...
            <main style={{ flexGrow: 1 }}>
                ...
                <section style={{ 
                    ...
                    <div className="container">
                        ...
                        <a href="https://wa.me/15208005239?text=Hello%20Fairplay%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ padding: '20px 60px', fontSize: '18px' }}>
                    ...
                    <div className="container">
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '60px', alignItems: 'center' }}>
                            ...
                            <div style={{ flex: '1', minWidth: '300px', textAlign: 'center', padding: '50px', background: 'rgba(255, 215, 0, 0.05)', borderRadius: '30px', border: '1px solid rgba(255, 215, 0, 0.1)' }}>
                                ...
                                <a href="https://wa.me/15208005239?text=Hello%20Fairplay%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ padding: '15px 40px' }}>
                                    JOIN MEGA CONTEST
                                </a>
                            </div>
                        </div>
                ...
                <section style={{ padding: '100px 20px', textAlign: 'center' }}>
                    <div className="container">
                        <div style={{ background: 'linear-gradient(135deg, #111 0%, #000 100%)', padding: '80px 40px', borderRadius: '40px', border: '1px solid #222' }}>
                            ...
                            <a href="https://wa.me/15208005239?text=Hello%20Fairplay%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="btn-whatsapp" style={{ padding: '20px 60px', fontSize: '20px' }}>
