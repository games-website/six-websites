...
const RulesRegulations = () => {
    ...
    return (
        <div className="rules-page" style={{ backgroundColor: 'var(--primary-green)', color: '#fff', minHeight: '100vh', paddingBottom: '40px' }}>
            <div className="container">
                ...
                <div className="policy-header" style={{
                    ...
                    <h1 style={{ color: 'var(--accent-yellow)', fontSize: '28px', margin: 0, fontWeight: '700' }}>Lotus365 Rules and Regulations</h1>
                </div>
                <p style={{ textAlign: 'center', marginBottom: '30px' }}>
                    Welcome to <strong style={{ color: 'var(--accent-yellow)' }}>Lotus365</strong>! This page explains all our rules in simple language so you can bet safely and enjoy your gaming experience.
                </p>
                ...
                <div style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>Who Can Use Lotus365?</p>
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                        <li style={{ marginBottom: '15px' }}><strong>Age Requirement:</strong> You must be 18 years or older to create an account and place bets on <strong style={{ color: 'var(--accent-yellow)' }}>Lotus365</strong>.</li>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', maxWidth: '1100px', margin: '0 auto 40px auto' }}>
                    <div style={sectionStyle}>
                        ...
                        <p style={{ fontSize: '14px', marginTop: '10px' }}><strong>Processing Time:</strong> Deposits are instant in most cases. If money is deducted from your account but not credited to Lotus365, contact support within 24 hours.</p>
                    </div>
                    <div style={sectionStyle}>
                        <div style={{ ...headerStyle, width: 'auto', minWidth: '0' }}>
                ...
                <div style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>Keep Your Account Safe</p>
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                        <li style={{ marginBottom: '15px' }}><strong>Password Protection:</strong> Use a strong password and never share it with anyone. Lotus365 will never ask for your password.</li>
                        <li style={{ marginBottom: '15px' }}><strong>Login Details:</strong> Keep your <strong style={{ color: 'var(--accent-yellow)' }}>Lotus365 ID</strong> and password confidential. You are responsible for all activity on your account.</li>
                    ...
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px', marginTop: '20px' }}>Account Suspension</p>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: 'var(--accent-yellow)', fontSize: '22px', margin: 0 }}>Responsible Gaming</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>Our Commitment</p>
                    <p style={{ marginBottom: '20px' }}>Lotus365 promotes responsible gambling. Gaming should be fun and entertaining, not a way to make money or solve financial problems.</p>
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>Self-Control Tools</p>
                    ...
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>Warning Signs of Problem Gambling</p>
                </div>
                {}
                <div className="policy-section-header" style={{
                    border: '1px solid var(--accent-yellow)',
                    ...
                    <h2 style={{ color: 'var(--accent-yellow)', fontSize: '22px', margin: 0 }}>Disputes and Complaints</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>How to Raise a Complaint</p>
                    ...
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>Important Points</p>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: 'var(--accent-yellow)', fontSize: '22px', margin: 0 }}>Technical Issues</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>Platform Errors</p>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: 'var(--accent-yellow)', fontSize: '22px', margin: 0 }}>Changes to Rules</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>Updates and Modifications</p>
                    <p style={{ marginBottom: '20px' }}>Lotus365 reserves the right to update these Rules and Regulations at any time.</p>
                    <p style={{ color: 'var(--accent-yellow)', fontStyle: 'italic', marginBottom: '15px' }}>How You'll Know:</p>
                    <ul style={{ listStyleType: 'disc', paddingLeft: '20px', marginBottom: '20px' }}>
                    ...
                    <p><strong>Your Agreement:</strong> By continuing to use <strong style={{ color: 'var(--accent-yellow)' }}>Lotus365</strong> after changes are made, you accept the updated rules.</p>
                </div>
                {}
                <div className="policy-section-header" style={{
                    border: '1px solid var(--accent-yellow)',
                ...
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    ...
                    <p style={{ marginBottom: '10px' }}><i className="fab fa-whatsapp"></i> <strong>WhatsApp:</strong> +447735317489</p>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: 'var(--accent-yellow)', fontSize: '22px', margin: 0 }}>Your Acceptance</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ marginBottom: '20px' }}>By registering and using <strong style={{ color: 'var(--accent-yellow)' }}>Lotus365</strong>, you confirm that:</p>
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: 'var(--accent-yellow)', fontSize: '22px', margin: 0 }}>Privacy and Data Protection</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto', textAlign: 'center' }}>
                    ...
                    <p>For complete details, read our <span style={{ color: 'var(--accent-yellow)' }}>Privacy Policy</span>.</p>
                </div>
                {}
                <div className="policy-section-header" style={{
                    border: '1px solid var(--accent-yellow)',
                    ...
                    <h2 style={{ color: 'var(--accent-yellow)', fontSize: '22px', margin: 0 }}>Important Disclaimers</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <ul style={{ listStyleType: 'disc', paddingLeft: '20px', lineHeight: '1.6' }}>
                        <li>Lotus365 is not responsible for losses incurred due to your betting decisions</li>
                    ...
                    <p style={{ marginTop: '20px', fontStyle: 'italic', color: 'var(--accent-yellow)' }}>Lotus365 – India’s Most Trusted Online Betting Platform.</p>
                    <p style={{ marginTop: '10px' }}>Create Your Account on <strong style={{ color: 'var(--accent-yellow)' }}>Lotus365 Book</strong> Platform.</p>
                    {}
                </div>
            </div>
        </div >
