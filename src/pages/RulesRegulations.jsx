            ...
            <div className="container">
                ...
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    ...
                    <div style={{ textAlign: 'right', marginTop: '-20px' }}>
                        <a href="https://wa.me/16402396837?text=Hello%20Reddyanna%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="btn-whatsapp" style={{
                ...
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    ...
                    <div style={{ textAlign: 'right', marginTop: '20px' }}>
                        <a href="https://wa.me/16402396837" target="_blank" rel="noopener noreferrer" className="btn-whatsapp" style={{
                            backgroundColor: '#25D366',
                            color: '#fff',
                            padding: '10px 20px',
                            borderRadius: '30px',
