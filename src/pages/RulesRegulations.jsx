        ...
        <div className="rules-page" style={{ backgroundColor: '#121c36', color: '#fff', minHeight: '100vh', paddingBottom: '40px' }}>
            <div className="container">
                ...
                <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                    <a href="https://wa.me/16402396837?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." className="btn-gold" style={{
                ...
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    ...
                    <div style={{ textAlign: 'right', marginTop: '-20px' }}>
                        <a href="https://wa.me/16402396837?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="btn-whatsapp" style={{
