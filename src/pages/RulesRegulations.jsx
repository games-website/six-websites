        ...
        <div className="rules-page" style={{ backgroundColor: '#121c36', color: '#fff', minHeight: '100vh', paddingBottom: '40px' }}>
            <div className="container">
                ...
                <div className="policy-header" style={{
                    ...
                    <h1 style={{ color: '#eab308', fontSize: '28px', margin: 0, fontWeight: '700' }}>Myleasers Rules and Regulations</h1>
                </div>

                <p style={{ textAlign: 'center', marginBottom: '30px' }}>
                    Welcome to <strong style={{ color: '#eab308' }}>Myleasers</strong>! This page explains all our rules in simple language so you can bet safely and enjoy your gaming experience.
                </p>

                <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                    <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." className="btn-gold" style={{
                ...
                <div style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>Who Can Use Myleasers?</p>
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                        <li style={{ marginBottom: '15px' }}><strong>Age Requirement:</strong> You must be 18 years or older to create an account and place bets on <strong style={{ color: '#eab308' }}>Myleasers</strong>.</li>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', maxWidth: '1100px', margin: '0 auto 40px auto' }}>
                    <div style={sectionStyle}>
                        ...
                        <p style={{ fontSize: '14px', marginTop: '10px' }}><strong>Processing Time:</strong> Deposits are instant in most cases. If money is deducted from your account but not credited to Myleasers, contact support within 24 hours.</p>
                ...
                <div style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>Keep Your Account Safe</p>
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                        <li style={{ marginBottom: '15px' }}><strong>Password Protection:</strong> Use a strong password and never share it with anyone. Myleasers will never ask for your password.</li>
                        <li style={{ marginBottom: '15px' }}><strong>Login Details:</strong> Keep your <strong style={{ color: '#eab308' }}>Myleasers ID</strong> and password confidential. You are responsible for all activity on your account.</li>
                    ...
                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px', marginTop: '20px' }}>Account Suspension</p>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: '#eab308', fontSize: '22px', margin: 0 }}>Responsible Gaming</h2>
                </div>

                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>Our Commitment</p>
                    <p style={{ marginBottom: '20px' }}>Myleasers promotes responsible gambling. Gaming should be fun and entertaining, not a way to make money or solve financial problems.</p>

                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>Self-Control Tools</p>
                    ...
                    <div style={{ textAlign: 'right', marginTop: '-20px' }}>
                        <a href="https://wa.me/15208005239?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="btn-whatsapp" style={{
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: '#eab308', fontSize: '22px', margin: 0 }}>Disputes and Complaints</h2>
                </div>

                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>How to Raise a Complaint</p>
                    ...
                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>Important Points</p>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: '#eab308', fontSize: '22px', margin: 0 }}>Technical Issues</h2>
                </div>

                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>Platform Errors</p>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: '#eab308', fontSize: '22px', margin: 0 }}>Changes to Rules</h2>
                </div>

                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>Updates and Modifications</p>
                    <p style={{ marginBottom: '20px' }}>Myleasers reserves the right to update these Rules and Regulations at any time.</p>

                    <p style={{ color: '#eab308', fontStyle: 'italic', marginBottom: '15px' }}>How You'll Know:</p>
                    <ul style={{ listStyleType: 'disc', paddingLeft: '20px', marginBottom: '20px' }}>
                    ...
                    <p><strong>Your Agreement:</strong> By continuing to use <strong style={{ color: '#eab308' }}>Myleasers</strong> after changes are made, you accept the updated rules.</p>
                </div>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: '#eab308', fontSize: '22px', margin: 0 }}>Contact Us</h2>
                </div>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: '#eab308', fontSize: '22px', margin: 0 }}>Your Acceptance</h2>
                </div>

                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <p style={{ marginBottom: '20px' }}>By registering and using <strong style={{ color: '#eab308' }}>Myleasers</strong>, you confirm that:</p>
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: '#eab308', fontSize: '22px', margin: 0 }}>Privacy and Data Protection</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto', textAlign: 'center' }}>
                    ...
                    <p>For complete details, read our <span style={{ color: '#eab308' }}>Privacy Policy</span>.</p>
                </div>
                ...
                <div className="policy-section-header" style={{
                    ...
                    <h2 style={{ color: '#eab308', fontSize: '22px', margin: 0 }}>Important Disclaimers</h2>
                </div>
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    <ul style={{ listStyleType: 'disc', paddingLeft: '20px', lineHeight: '1.6' }}>
                        <li>Myleasers is not responsible for losses incurred due to your betting decisions</li>
                    ...
                    <p style={{ marginTop: '20px', fontSize: '14px' }}><strong>Last Updated:</strong> November 2026</p>
                    <p style={{ marginTop: '20px', fontWeight: 'bold' }}>Play Smart. Play Fair. Play Responsibly.</p>
                    <p style={{ marginTop: '20px', fontStyle: 'italic', color: '#eab308' }}>Myleasers – India’s Most Trusted Online Betting Platform.</p>
