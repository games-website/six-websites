        ...
        <div className="service-page basketball-page">
            <section className="hero-simple bg-basketball">
                <div className="container">
                    ...
                    <a href="https://wa.me/16402396837?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." className="btn-gold reveal">GET YOUR BASKETBALL ID</a>
                </div>
            </section>
            ...
            <section className="cta-section">
                <div className="container text-center">
                    ...
                    <div className="cta-buttons reveal">
                        <a href="https://wa.me/16402396837?text=Hello%20Myleasers%2C%20I%20want%20to%20get%20my%20ID." className="btn-gold large">GET ID NOW</a>
