...
const Tennis = () => {
    ...
    return (
        <div className="tennis-page" style={{ backgroundColor: '#111111', color: '#fff', minHeight: '100vh' }}>
                ...
                <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '40px', flexWrap: 'wrap' }}>
                    <div style={{ flex: '1', minWidth: '300px' }}>
                        <div style={{ ...headerStyle, fontSize: '24px', lineHeight: '1.4' }}>
                            Myleasers Tennis Betting – Bet <br /> on Live Tennis Matches
                        </div>
                        <p style={{ lineHeight: '1.6', marginBottom: '20px', color: '#ccc', fontSize: '16px' }}>
                            Welcome to <span style={{ color: '#eab308' }}>Myleasers</span>, your ultimate destination for live tennis betting in India. With our platform, you can enjoy real-time <strong>Myleasers Tennis</strong> betting and access all major tennis tournaments, including Wimbledon, US Open, French Open, and Australian Open. Whether you’re a beginner or an experienced bettor, our platform ensures a smooth and secure experience for every user.
                        </p>
                ...
                <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <div style={{ marginBottom: '30px' }}>
                        <div style={sectionTitleStyle}>
                            How to Get Started with Myleasers Tennis Betting
                        </div>
                    </div>

                    <p style={{ color: '#ccc', lineHeight: '1.8', fontSize: '18px', marginBottom: '20px' }}>
                        Getting started is simple. First, create your <span style={{ color: '#eab308' }}>Myleasers ID</span> by registering on our official platform. Once your account is ready, log in through <strong>Myleasers Login</strong> and explore our tennis betting options. You can place pre-match bets, track live odds, and enjoy fast deposits and withdrawals using our trusted payment methods.
                    </p>
                </div>
            </section>
            ...
            <section style={{ padding: '60px 20px', backgroundColor: '#111111' }}>
                <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <div style={{ marginBottom: '30px' }}>
                        <div style={sectionTitleStyle}>
                            Why Choose Myleasers for Tennis Betting
                        </div>
                    </div>

                    <p style={{ color: '#ccc', lineHeight: '1.8', fontSize: '18px', marginBottom: '20px' }}>
                        We understand Indian bettors' needs. That’s why <strong>Myleasers Sports Betting</strong> offers:
                    </p>
            ...
            <section style={{ padding: '60px 20px', backgroundColor: '#000' }}>
                <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <div style={{ marginBottom: '30px' }}>
                        <div style={sectionTitleStyle}>
                            Features of Myleasers Tennis Betting
                        </div>
                    </div>
            ...
            <section style={{ padding: '60px 20px', backgroundColor: '#111111' }}>
                <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    ...
                    <p style={{ color: '#ccc', lineHeight: '1.8', fontSize: '18px' }}>
                        At <span style={{ color: '#eab308' }}>Myleasers</span>, we promote responsible gaming. Set your limits, bet only what you can afford, and enjoy tennis betting as a fun and exciting activity.
                    </p>
                </div>
            </section>
            ...
            <section style={{ padding: '60px 20px', backgroundColor: '#000' }}>
                <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <div style={{ marginBottom: '30px' }}>
                        <div style={sectionTitleStyle}>
                            Join Myleasers Today
                        </div>
                    </div>
                    <p style={{ color: '#ccc', lineHeight: '1.8', fontSize: '18px', marginBottom: '30px' }}>
                        Start your tennis betting journey with <span style={{ color: '#eab308' }}>Myleasers ID</span> today. Place bets on your favorite tennis matches, enjoy live action, and experience a safe and trusted online sports betting platform designed for Indian players.
                        <br /><br />
                        Create Account on <span style={{ color: '#eab308' }}>Myleasers Book Online</span> Platform
                    </p>
                </div>
            </section>
