...
const Football = () => {
    ...
    return (
        <div className="football-page" style={{ backgroundColor: '#111111', color: '#fff', minHeight: '100vh' }}>
                ...
                <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '40px', flexWrap: 'wrap' }}>
                    <div style={{ flex: '1', minWidth: '300px' }}>
                        <div style={headerStyle}>
                            Myleasers Football Betting
                        </div>
                        <h2 style={{ fontSize: '28px', marginBottom: '20px', fontWeight: 'bold' }}>
                            Experience Premium Football Betting with Myleasers
                        </h2>
                    ...
                    <div style={{ flex: '1', minWidth: '300px' }}>
                        <img
                            ...
                            alt="Myleasers Football Betting"
            ...
            <section style={{ padding: '60px 20px', backgroundColor: '#000' }}>
                <div className="container" style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: '50px' }}>
                        <div style={headerStyle}>
                            Why Choose Myleasers for Football Betting?
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap-reverse', gap: '40px', alignItems: 'center' }}>
                        ...
                        <div style={{ flex: '2 1 500px', padding: '20px' }}>
                            <div style={{ marginBottom: '30px' }}>
                                <h3 style={{ color: '#eab308', fontSize: '20px', marginBottom: '10px', fontStyle: 'italic' }}>Understanding Odds and Probability</h3>
                            ...
                            <div style={{ marginBottom: '30px' }}>
                                <h3 style={{ color: '#eab308', fontSize: '20px', marginBottom: '10px', fontStyle: 'italic' }}>Bankroll Management Strategies</h3>
                            ...
                            <div style={{ marginBottom: '30px' }}>
                                <h3 style={{ color: '#eab308', fontSize: '20px', marginBottom: '10px', fontStyle: 'italic' }}>Research and Analysis</h3>
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px', color: '#ccc', lineHeight: '1.6' }}>
                            ...
                            <div style={{ marginBottom: '30px' }}>
                                <h3 style={{ color: '#eab308', fontSize: '20px', marginBottom: '10px', fontStyle: 'italic' }}>Popular Betting Strategies</h3>
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px', color: '#ccc', lineHeight: '1.6' }}>
            ...
            <section style={{ padding: '60px 20px', backgroundColor: '#000', textAlign: 'center' }}>
                <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <div style={{
                        ...
                        Start Your Football Betting Journey with Myleasers Today
                    </div>
                    <p style={{ color: '#ccc', lineHeight: '1.6', marginBottom: '20px' }}>
                        Experience the excitement of online football betting with <span style={{ color: '#eab308' }}>Myleasers</span> India’s premier betting platform. Register now and receive your welcome bonus to begin wagering on your favourite teams and leagues.
                    </p>
                    <p style={{ color: '#888', fontStyle: 'italic', marginBottom: '40px' }}>
                        Gamble responsibly. Terms and conditions apply. 18+ only.
                    </p>
                    <p style={{ color: '#fff', fontSize: '18px' }}>
                        Join <span style={{ color: '#eab308' }}>Myleasers Book</span> Platform
                    </p>
                </div>
            </section>
