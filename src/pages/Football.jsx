...
import strategyFootball from '../assets/strategy_football.png';
const Football = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div className="football-page" style={{ backgroundColor: 'var(--primary-green)', color: '#fff', minHeight: '100vh' }}>
            { }
            ...
            <section style={{ padding: '60px 20px', backgroundColor: 'var(--dark-green)' }}>
                <div className="container" style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: '50px' }}>
                        <div style={headerStyle}>
                            Why Choose Lotus365 for Football Betting?
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap-reverse', gap: '40px', alignItems: 'center' }}>
                        <div style={{ flex: '2 1 500px', padding: '20px' }}>
                            <div style={{ marginBottom: '30px' }}>
                                <h3 style={{ color: 'var(--accent-yellow)', fontSize: '20px', marginBottom: '10px', fontStyle: 'italic' }}>Understanding Odds and Probability</h3>
                            ...
                            <div style={{ marginBottom: '30px' }}>
                                <h3 style={{ color: 'var(--accent-yellow)', fontSize: '20px', marginBottom: '10px', fontStyle: 'italic' }}>Bankroll Management Strategies</h3>
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px', color: '#eee', lineHeight: '1.6' }}>
                            ...
                            <div style={{ marginBottom: '30px' }}>
                                <h3 style={{ color: 'var(--accent-yellow)', fontSize: '20px', marginBottom: '10px', fontStyle: 'italic' }}>Research and Analysis</h3>
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px', color: '#eee', lineHeight: '1.6' }}>
                            ...
                            <div style={{ marginBottom: '30px' }}>
                                <h3 style={{ color: 'var(--accent-yellow)', fontSize: '20px', marginBottom: '10px', fontStyle: 'italic' }}>Popular Betting Strategies</h3>
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px', color: '#eee', lineHeight: '1.6' }}>
            ...
            { }
            <section style={{ padding: '60px 20px', backgroundColor: 'var(--dark-green)', textAlign: 'center' }}>
                <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <div style={{
                        ...
                        Start Your Football Betting Journey with Lotus365 Today
                    </div>
                    <p style={{ color: '#eee', lineHeight: '1.6', marginBottom: '20px' }}>
                        Experience the excitement of online football betting with <span style={{ color: 'var(--accent-yellow)' }}>Lotus365</span> India’s premier betting platform. Register now and receive your welcome bonus to begin wagering on your favourite teams and leagues.
                    </p>
                    <p style={{ color: '#ccc', fontStyle: 'italic', marginBottom: '40px' }}>
                        Gamble responsibly. Terms and conditions apply. 18+ only.
                    </p>
                    <p style={{ color: '#fff', fontSize: '18px' }}>
                        Join <span style={{ color: 'var(--accent-yellow)' }}>Lotus365 Book</span> Platform
                    </p>
                </div>
            </section>
            { }
