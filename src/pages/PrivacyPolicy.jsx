            ...
            <div className="container">
                ...
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    ...
                    <ul style={{ listStyleType: 'none', paddingLeft: '0', lineHeight: '1.8', textAlign: 'center' }}>
                        ...
                        <li style={{ marginBottom: '10px' }}><strong>WhatsApp:</strong> <a href="https://wa.me/15208005239" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-yellow)', textDecoration: 'none' }}>+15208005239</a></li>
                    </ul>
                </div>
            </div>
        </div>
