...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="privacy-page" style={{ backgroundColor: '#111111', color: '#fff', minHeight: '100vh', paddingBottom: '40px' }}>
            <div className="container" style={{ padding: '40px 20px' }}>
                ...
                <div style={{ ...sectionStyle, textAlign: 'center' }}>
                    <p style={contentStyle}>
                        We, <strong style={{ color: '#eab308' }}>Myleasers</strong> is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our cricket betting platform, mobile application, and related services.
                    </p>
                </div>
