            ...
            <div className="container">
                ...
                <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto 40px auto' }}>
                    ...
                    <ul style={{ listStyleType: 'none', paddingLeft: '0', lineHeight: '1.8', textAlign: 'center' }}>
                        ...
                        <li style={{ marginBottom: '10px' }}><strong>WhatsApp:</strong> <a href="https://wa.me/16402396837?text=Hello%20Lotus365%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-yellow)', textDecoration: 'none' }}>+16402396837</a></li>
                    </ul>
                </div>
            </div>
        </div>
