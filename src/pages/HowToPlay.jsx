...
const HowToPlay = () => {
    ...
    return (
        <div className="how-to-play-page" style={{ backgroundColor: 'var(--primary-green)', color: '#fff', minHeight: '100vh', paddingTop: '100px' }}>
            {}
            <div className="container" style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 20px', textAlign: 'center', marginBottom: '60px' }}>
                <div style={sectionTitleStyle}>
                    How to Bet on Lotus365 Online Cricket Betting & Casino Games
                </div>
                <p style={{ color: '#ccc', lineHeight: '1.8', fontSize: '16px', marginTop: '20px', marginBottom: '30px' }}>
                    <span style={{ color: 'var(--accent-yellow)' }}>Lotus365</span> is a trusted platform for online sports betting and casino games. Whether you enjoy betting on cricket, football, or trying your luck in casino games like slots and poker, Lotus365 makes online gaming easy, secure, and fun. This guide will show you how to start and enjoy the platform responsibly.
                </p>
            ...
            <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px 60px' }}>
                <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                    <div style={sectionTitleStyle}>Guide to Bet on Lotus365</div>
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
                    {}
                    <div style={cardStyle}>
                        <div style={cardHeaderStyle}>1. Creating a Lotus365 Account</div>
                        ...
                        <ol style={{ paddingLeft: '20px', color: '#ccc', lineHeight: '1.6', marginBottom: '20px' }}>
                            <li style={{ marginBottom: '10px' }}>Visit the <span style={{ color: 'var(--accent-yellow)' }}>official Lotus365 website</span>.</li>
                        ...
                        <div style={{ borderLeft: '3px solid var(--accent-yellow)', paddingLeft: '15px', color: '#ccc', fontStyle: 'italic' }}>
                    ...
                    <div style={cardStyle}>
                        ...
                        <ul style={{ paddingLeft: '20px', color: '#ccc', lineHeight: '1.6', marginBottom: '20px' }}>
                            <li style={{ marginBottom: '10px' }}>Lotus365 supports multiple payment options like <strong>UPI, cards, e-wallets</strong>, and sometimes <strong>cryptocurrency</strong>.</li>
                    ...
                    {}
                    <div style={cardStyle}>
                        <div style={cardHeaderStyle}>3. Understanding Sports Betting on Lotus365</div>
                        <p style={{ color: '#ccc', marginBottom: '15px' }}>Lotus365 offers a variety of sports betting options:</p>
                        <ul style={{ paddingLeft: '20px', color: '#ccc', lineHeight: '1.6', marginBottom: '20px' }}>
                    ...
                    {}
                    <div style={cardStyle}>
                        <div style={cardHeaderStyle}>4. Playing Lotus365 Casino Games</div>
                        <p style={{ color: '#ccc', marginBottom: '15px' }}>Lotus365 also offers a wide range of casino games:</p>
                        <ul style={{ paddingLeft: '20px', color: '#ccc', lineHeight: '1.6', marginBottom: '20px' }}>
                    ...
                    <div style={cardStyle}>
                        ...
                        <ol style={{ paddingLeft: '20px', color: '#ccc', lineHeight: '1.6', marginBottom: '20px' }}>
                            <li style={{ marginBottom: '10px' }}>Go to the <strong>Withdraw section</strong> in your <span style={{ color: 'var(--accent-yellow)' }}>Lotus365</span> account.</li>
