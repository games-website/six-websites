                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px' }}>
                        <div style={{ flex: '1', minWidth: '320px', background: '#111', padding: '50px', borderRadius: '30px', border: '1px solid #222' }}>
                            ...
                            <div style={{ marginTop: '50px' }}>
                                 <a href="https://wa.me/15208005239?text=Hello%20Fairplay%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="btn-whatsapp" style={{ width: '100%', textAlign: 'center', padding: '20px', borderRadius: '50px', fontSize: '18px', display: 'block' }}>
