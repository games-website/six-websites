                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                    <div className="bg-[#1a2236] border border-yellow-500/30 rounded-3xl p-8 flex flex-col items-center text-center h-full">
                        ...
                        <div className="text-white text-lg leading-loose">
                            <p>Mahadev Book WhatsApp Number – <a href="https://wa.me/15208005239?text=Hello%20Mahadevbook%2C%20I%20want%20to%20get%20my%20ID." className="text-yellow-500 hover:underline">+15208005239</a></p>
                        </div>
                    </div>
