...
const AboutUs = () => {
    ...
    const iconCircleStyle = {
        ...
        height: '80px',
        borderRadius: '50%',
        background: 'linear-gradient(135deg, #eab308, #ffaa00)',
        display: 'flex',
    ...
    return (
        <div style={{ backgroundColor: '#111111', minHeight: '100vh', paddingTop: '100px', paddingBottom: '80px' }}>

            { }
            <div style={containerStyle}>
                <div style={sectionBorderBox}>
                    <h1 style={{ ...sectionTitleStyle, fontSize: 'clamp(20px, 5vw, 28px)', wordWrap: 'break-word', maxWidth: '100%', boxSizing: 'border-box' }}>Myleasers - Trusted Online Cricket Betting ID Provider in India</h1>
                </div>

                <div style={{ marginBottom: '60px', lineHeight: '1.8', fontSize: '16px', color: '#ccc' }}>
                    <p style={{ marginBottom: '20px' }}>
                        Welcome to <span style={{ color: '#eab308' }}>Myleasers</span>, your trusted Betting ID’s for online gaming and sports betting in India since 2010. Since our inception, we’ve been committed to providing a safe, fair, and enjoyable gaming experience for players across the country.
                    </p>
                    <p>
                        At Myleasers, we believe in innovation, transparency, and player satisfaction. we are <span style={{ color: '#eab308' }}>trusted online betting ID provider</span> and wide range of games — from live casino classics to sports betting and skill-based games — all designed to give you maximum entertainment and winning opportunities.
                    </p>
                </div>
                ...
                <div style={{ ...sectionBorderBox, padding: '15px', display: 'inline-block', marginBottom: '50px', minWidth: '60%' }}>
                    <h2 style={{ ...sectionTitleStyle, fontSize: '24px' }}>Why Choose Myleasers?</h2>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginBottom: '80px' }}>
                    ...
                    <div style={cardStyle}>
                        ...
                        <h3 style={{ color: '#eab308', fontSize: '18px', marginBottom: '15px' }}>TRUSTED & SECURE</h3>
                    ...
                    <div style={cardStyle}>
                        <div style={iconCircleStyle}>💳</div>
                        <h3 style={{ color: '#eab308', fontSize: '18px', marginBottom: '15px' }}>MULTIPLE PAYMENT OPTIONS</h3>
                        <p style={{ fontSize: '14px', color: '#ccc', lineHeight: '1.6' }}>
                    ...
                    <div style={cardStyle}>
                        <div style={iconCircleStyle}>⭐</div>
                        <h3 style={{ color: '#eab308', fontSize: '18px', marginBottom: '15px' }}>PLAYER-CENTRIC APPROACH</h3>
                        <p style={{ fontSize: '14px', color: '#ccc', lineHeight: '1.6' }}>
                    ...
                    <div style={cardStyle}>
                        <div style={iconCircleStyle}>🎯</div>
                        <h3 style={{ color: '#eab308', fontSize: '18px', marginBottom: '15px' }}>FAIR & TRANSPARENT GAMING</h3>
                        <p style={{ fontSize: '14px', color: '#ccc', lineHeight: '1.6' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
                    ...
                    <div style={infoCardStyle}>
                        ...
                        <p style={{ color: '#fff', fontWeight: 'bold' }}>Join Myleasers Book Now</p>
                    </div>
                    ...
                    <div style={infoCardStyle}>
                        ...
                        <p style={{ color: '#ccc', lineHeight: '1.8' }}>
                            Join the <span style={{ color: '#eab308' }}>Myleasers</span> community today and experience world-class gaming, seamless payments, and unmatched support.
                        </p>
                    </div>
                    ...
                    <div style={infoCardStyle}>
                        ...
                        <div style={{ color: '#fff', fontSize: '16px', lineHeight: '2' }}>
                            <p>Myleasers WhatsApp Number – +15208005239</p>
                        </div>
                    </div>
                    ...
                    <div style={infoCardStyle}>
                        ...
                        <p style={{ color: '#eab308', fontWeight: 'bold', marginBottom: '15px' }}>Author – Daniel Smyth</p>
