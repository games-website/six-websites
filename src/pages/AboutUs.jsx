                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20 text-center">
                    <div className="bg-white border border-gray-100 rounded-3xl p-10 flex flex-col items-center h-full shadow-md">
                        ...
                        <p className="text-gray-600 font-medium text-lg">
                            ...
                            <a href="https://wa.me/15208005239?text=Hello%20Goldplay%2C%20I%20want%20to%20get%20my%20ID." className="text-brand-gold font-black hover:underline mt-2 block text-2xl">+1 (520) 800-5239</a>
                        </p>
                    </div>
