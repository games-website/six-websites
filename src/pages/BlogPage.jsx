    ...
    const blogPosts = [
        {
            ...
            author: "Daniel Smyth",
            image: "/images/myleasers_blog_trends.png",
            link: "#"
        },
        {
            id: 2,
            ...
            author: "Daniel Smyth",
            image: "/images/myleasers_blog_cricket.png",
            link: "#"
        },
        {
            id: 3,
            ...
            date: "February 11, 2026",
            author: "Daniel Smyth",
            image: "/images/myleasers_blog_nba.png",
            link: "#"
        },
        {
            id: 4,
            title: "Data Privacy & User Protection Policies on Myleasers",
        ...
        {
            id: 5,
            title: "Myleasers App vs Website – Which Is Better for Users?",
            date: "February 10, 2026",
            author: "Daniel Smyth",
        ...
        {
            id: 6,
            title: "Why Myleasers Book Is a Trusted Online Betting Platform",
        ...
        {
            id: 7,
            title: "Top 5 Strategies for Winning Big on Myleasers Casino",
        ...
        {
            id: 9,
            title: "How to Secure Your Myleasers Account from Fraud",
        ...
        {
            id: 10,
            title: "The Rise of Fantasy Sports in India: Myleasers's Role",
        ...
        ...Array.from({ length: 35 }, (_, i) => ({
            id: 11 + i,
            title: `Myleasers Betting Tips & Tricks Vol. ${i + 1}: Mastering ${['Cricket', 'Football', 'Tennis', 'Casino', 'Slots'][i % 5]}`,
                        ...
                        <div key={post.id} style={{
                            ...
                            <div style={{ height: '200px', overflow: 'hidden' }}>
                                <img
                                    ...
                                    onError={(e) => { e.target.src = 'https://via.placeholder.com/400x250?text=Myleasers+Insight' }}
                                />
                            </div>
