            ...
            <main className="flex-grow container mx-auto px-4 py-8 mb-10">
                ...
                <div className="max-w-4xl mx-auto mb-10 text-gray-300">
                    ...
                    <div className="text-right -mt-6">
                        <a href="https://wa.me/15208005239" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-6 rounded-full transition-colors">
                ...
                <div className="max-w-4xl mx-auto mb-10 text-gray-300 text-center">
                    ...
                    <p className="mb-2"><strong>WhatsApp:</strong> +1(520)800-5239</p>
                ...
                <div className="max-w-4xl mx-auto mb-10 text-gray-300">
                    ...
                    <div className="text-center mt-8">
                        <a href="https://wa.me/15208005239" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-full transition-colors">
