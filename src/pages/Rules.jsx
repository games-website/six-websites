            ...
            <main className="flex-grow container mx-auto px-4 py-8 mb-10">
                ...
                <div className="bg-gray-100 rounded-3xl p-10 md:p-16 text-center shadow-inner mb-12 border border-gray-200">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 justify-center">
                        <a href="https://wa.me/15208005239?text=Hello%20Goldplay%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1ebc51] text-white font-bold py-4 px-10 rounded-full shadow-lg transition-transform hover:scale-105">
                ...
                <div className="max-w-4xl mx-auto mb-10 text-gray-600 font-medium text-center bg-white p-10 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                            ...
                            <p className="text-brand-gold font-bold">+1 (520) 800-5239</p>
                        </div>
                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
