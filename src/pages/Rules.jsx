            ...
            <main style={{ flexGrow: 1, padding: '80px 20px' }}>
                <div className="container" style={{ maxWidth: '900px', margin: '0 auto' }}>
                    ...
                    <div style={{ marginTop: '60px', textAlign: 'center', background: 'rgba(255, 215, 0, 0.05)', padding: '40px', borderRadius: '30px', border: '1px solid rgba(255, 215, 0, 0.1)' }}>
                        ...
                        <a href="https://wa.me/16402396837?text=Hello%20Fairplay%2C%20I%20want%20to%20get%20my%20ID." target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ marginTop: '30px', padding: '15px 40px' }}>
                            CHAT WITH US
                        </a>
                    </div>
                </div>
