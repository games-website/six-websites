                ...
                <section className="bg-gray-100 py-16 px-4 relative overflow-hidden">
                    ...
                    <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-12 relative z-10">
                        <div className="flex-1 min-w-[300px] text-center md:text-left">
                            <div className="border border-red-200 bg-red-100 backdrop-blur-sm rounded-full py-2 px-6 mb-6 inline-block text-red-600 text-lg font-bold tracking-wide animate-pulse">
                                ♣️♠️ Live Casino Action
                            </div>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight uppercase bg-gradient-to-r from-red-600 via-brand-gold to-brand-gold-dark bg-clip-text text-transparent">
                                Real Casino Experience
                            </h1>
                            <p className="text-gray-600 leading-relaxed mb-8 text-lg md:text-xl font-medium">
                                Play with live professional dealers. Roulette, Blackjack, Baccarat, and Poker — streamed in HD to your device. Join <span className="text-brand-gold font-bold">Goldplay</span> for the ultimate casino thrill.
                            </p>
                            <a
                ...
                <section className="bg-white py-20 px-4">
                    <div className="container mx-auto max-w-6xl">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-bold text-gray-900 mb-4 uppercase tracking-tight">Popular Live Games</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={idx} className="bg-gray-50 border border-gray-100 p-8 rounded-2xl hover:border-brand-gold/50 transition-all duration-300 group hover:-translate-y-2 shadow-sm hover:shadow-md">
                                    <div className="text-4xl mb-4 text-brand-gold bg-white w-14 h-14 rounded-full flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">{item.icon}</div>
                ...
                <section className="bg-gray-100 py-20 px-4">
                    <div className="container mx-auto max-w-5xl">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="bg-white p-8 rounded-3xl border border-brand-gold/20 shadow-lg">
                                <h3 className="text-2xl font-bold text-gray-900 mb-6 uppercase tracking-wider">Experience the VIP Life</h3>
                                ...
                                <ul className="space-y-4 mb-8">
                                    {[
                                        ...
                                        <li key={i} className="flex items-center gap-3 text-brand-gold font-bold">
                                            <span className="text-xl">👑</span> {feat}
                                        </li>
                                    ))}
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-3xl font-bold text-gray-900 mb-6 uppercase tracking-tight">Fair & Secure Gaming</h3>
                ...
                <section className="bg-white py-20 px-4 text-center">
                    <div className="container mx-auto max-w-4xl bg-gray-50 rounded-3xl p-10 md:p-16 border border-gray-100 shadow-xl">
                        ...
                        <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto font-medium">
                            Join <span className="text-brand-gold font-bold">Goldplay Casino</span> and win big today!
                        </p>
                        <a
                            href="https://wa.me/6289183063?text=Hello%20Goldplay%2C%20I%20want%20to%20get%20my%20ID."
                            target="_blank"
