                    ...
                    <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-12 relative z-10">
                        ...
                        <div className="flex-1 min-w-[300px] w-full max-w-lg">
                            <img
                                ...
                                alt="Goldplay Horse Race Betting"
                ...
                <section className="bg-white py-20 px-4">
                    <div className="container mx-auto max-w-6xl">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-bold text-gray-900 mb-4 uppercase tracking-tight">Key Features</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={idx} className="bg-gray-50 border border-gray-100 p-8 rounded-2xl hover:border-brand-gold/50 transition-all duration-300 group hover:-translate-y-2 shadow-sm hover:shadow-md">
                                    <div className="text-4xl mb-4 text-brand-gold bg-white w-14 h-14 rounded-full flex items-center justify-center shadow-inner">{item.icon}</div>
                ...
                <section className="bg-gray-100 py-20 px-4">
                    <div className="container mx-auto max-w-5xl">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="bg-white p-8 rounded-2xl border border-brand-gold/20 shadow-lg">
                                <h3 className="text-2xl font-bold text-gray-900 mb-6 uppercase tracking-wider">How to Start Betting</h3>
                                <div className="space-y-6">
                                    {[
                                        ...
                                        <div key={i} className="flex gap-4">
                                            <div className="w-8 h-8 rounded-full bg-gold-gradient flex items-center justify-center text-white font-bold flex-shrink-0">{s.step}</div>
                                            <div>
                                                <h4 className="text-gray-900 font-bold">{s.title}</h4>
                            ...
                            <div>
                                <h3 className="text-3xl font-bold text-gray-900 mb-6 uppercase tracking-tight">Race to Victory</h3>
                                <p className="text-gray-600 leading-relaxed text-lg mb-8 font-medium">
                                    Horse racing combines strategy, analysis, and thrill. With Goldplay, you get the best platform to test your skills.
                                    <br /><br />
