            ...
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div className="md:w-1/2">
                        <h2 className="text-3xl md:text-5xl font-bold mb-8 text-yellow-600 leading-tight">
                            Download the Mahadev Book App – India’s Most Trusted Online Betting Platform
                        </h2>
                        <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                            Looking for a reliable and feature-rich online betting app in India? The <span className="text-yellow-600 font-bold underline decoration-yellow-600/50">Mahadev Book Official App</span> is your go-to destination for secure sports betting, live cricket, and casino games. Whether you’re a seasoned player or a first-timer, the app delivers a seamless, fast, and secure experience right at your fingertips.
                        </p>
                        ...
                        <h3 className="text-2xl font-bold text-yellow-600 mb-6">Key Features</h3>
                    ...
                    <div className="md:w-1/2 flex justify-center">
                        {/* Phone Mockup Container to match styling */}
