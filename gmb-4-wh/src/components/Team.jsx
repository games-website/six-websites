        ...
        <section className="py-20 bg-gray-50 text-gray-900">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold mb-4 text-yellow-600">Meet Our Expert Team</h2>
                    ...
                    {team.map((member, index) => (
                        <div key={index} className="bg-white rounded-xl overflow-hidden hover:shadow-xl transition-shadow border border-gray-200">
                            ...
                            <div className="p-6 text-center">
                                ...
                                <p className="text-yellow-600 text-sm font-semibold mb-3 uppercase tracking-wider">{member.role}</p>
