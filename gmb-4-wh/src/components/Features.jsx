        ...
        <section id="features" className="py-20 bg-white text-gray-900 relative">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold mb-4 text-yellow-600">Why Choose Mahadev Book?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div key={index} className="bg-gray-50 border border-gray-200 p-8 rounded-xl hover:border-yellow-600/50 transition-all hover:-translate-y-2 hover:shadow-lg group">
