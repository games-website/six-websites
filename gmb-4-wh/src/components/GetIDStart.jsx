    ...
    return (
        <section className="py-20 bg-gray-50 text-gray-900 px-4 border-t border-gray-200">
            <div className="container mx-auto max-w-5xl">
                <h2 className="text-3xl md:text-5xl font-bold mb-8 text-center text-yellow-600 uppercase">
                ...
                <div className="space-y-8 text-gray-600 text-lg leading-relaxed">
                    ...
                    <ul className="space-y-4 ml-4">
                        <li className="flex items-start gap-3">
                            ...
                            <span>
                                Quick and hassle-free registration with your own <strong className="text-gray-900">Mahadev Book ID</strong>.
                            </span>
                        </li>
                        <li className="flex items-start gap-3">
                            <ArrowRight className="text-gray-900 flex-shrink-0 mt-1.5" size={20} />
                            <span>
                                Instant <strong className="text-yellow-600">login access</strong> for seamless play across devices.
                            </span>
                        </li>
                        <li className="flex items-start gap-3">
                            <ArrowRight className="text-gray-900 flex-shrink-0 mt-1.5" size={20} />
                    ...
                    <p className="font-medium text-gray-900">
                        Ready to begin? <strong className="text-gray-900">Get your Mahadev Book ID now</strong> and unlock a premium betting experience trusted across India.
                    </p>
                </div>
