            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="md:w-1/2">
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-yellow-600">What is Mahadev Book?</h2>
                    ...
                    <div className="md:w-1/2">
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl border-2 border-yellow-500/20">
                            {/* Placeholder for About Image - could use a generic gambling/sports image */}
                            <img
                                src={secureIcon}
                                alt="Secure Betting"
