        ...
        <section className="py-20 bg-white text-gray-900 px-4 border-t border-gray-100">
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold mb-4 text-yellow-600">
                        Get to Know Your Betting ID
                    </h2>
                    <div className="h-1 w-16 bg-yellow-600 mx-auto mb-6"></div>
                ...
                {/* Content Block 1 */}
                <div className="mb-12">
                    <h3 className="text-2xl font-bold text-yellow-600 mb-4">What is a Mahadev Book ID?</h3>
                    <p className="text-gray-700 leading-relaxed mb-4">
                        Your <strong className="text-yellow-600">Mahadev Book ID</strong> is a personal access key to India’s trusted online betting ecosystem. With it, you can securely place bets on sports, casino games, and virtual matches within a single platform.
                    </p>
                ...
                {/* Cards Section */}
                <div className="mb-12">
                    <h3 className="text-2xl font-bold text-yellow-600 mb-8">How to Use It Smartly</h3>
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-t border-gray-200 pt-8">
                    <div>
                        <h3 className="text-2xl font-bold text-yellow-600 mb-2">Responsible Betting</h3>
